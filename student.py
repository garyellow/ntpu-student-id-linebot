            ...
            TemplateSendMessage(
                ...
                template=ButtonsTemplate(
                    ...
                    actions=[
                        PostbackAction(
                            label='中國文學系',
                            display_text='正在爬取中國文學系(' + event.postback.data.split('人文學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('人文學院')[1] + ' ' + department_number['中文']
                        ),
                        PostbackAction(
                            label='應用外語學系',
                            display_text='正在爬取應用外語學系(' + event.postback.data.split('人文學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('人文學院')[1] + ' ' + department_number['應外']
                        ),
                        PostbackAction(
                            label='歷史學系',
                            display_text='正在爬取歷史學系(' + event.postback.data.split('人文學院')[1] + ')，請稍後...',
            ...
            TemplateSendMessage(
                ...
                template=ButtonsTemplate(
                    ...
                    actions=[
                        PostbackAction(
                            label='企業管理學系',
                            display_text='正在爬取企業管理學系(' + event.postback.data.split('商學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('商學院')[1] + ' ' + department_number['企管']
                        ),
                        PostbackAction(
                            label='金融與合作經濟學系',
                            display_text='正在爬取金融與合作經濟學系(' + event.postback.data.split('商學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('商學院')[1] + ' ' + department_number['金融']
                        ),
                        PostbackAction(
                            label='會計學系',
                            display_text='正在爬取會計學系(' + event.postback.data.split('商學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('商學院')[1] + ' ' + department_number['會計']
                        ),
                        PostbackAction(
                            label='統計學系',
                            display_text='正在爬取統計學系(' + event.postback.data.split('商學院')[1] + ')，請稍後...',
            ...
            TemplateSendMessage(
                ...
                template=ButtonsTemplate(
                    ...
                    actions=[
                        PostbackAction(
                            label='公共行政暨政策學系',
                            display_text='正在爬取公共行政暨政策學系(' + event.postback.data.split('公共事務學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('公共事務學院')[1] + ' ' + department_number['公行']
                        ),
                        PostbackAction(
                            label='不動產與城鄉環境學系',
                            display_text='正在爬取不動產與城鄉環境學系(' + event.postback.data.split('公共事務學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('公共事務學院')[1] + ' ' + department_number['不動']
                        ),
                        PostbackAction(
                            label='財政學系',
                            display_text='正在爬取財政學系(' + event.postback.data.split('公共事務學院')[1] + ')，請稍後...',
            ...
            TemplateSendMessage(
                ...
                template=ButtonsTemplate(
                    ...
                    actions=[
                        PostbackAction(
                            label='經濟學系',
                            display_text='正在爬取經濟學系(' + event.postback.data.split('社會科學學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('社會科學學院')[1] + ' ' + department_number['經濟']
                        ),
                        PostbackAction(
                            label='社會學系',
                            display_text='正在爬取社會學系(' + event.postback.data.split('社會科學學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('社會科學學院')[1] + ' ' + department_number['社學']
                        ),
                        PostbackAction(
                            label='社會工作學系',
                            display_text='正在爬取社會工作學系(' + event.postback.data.split('社會科學學院')[1] + ')，請稍後...',
            ...
            TemplateSendMessage(
                ...
                template=ButtonsTemplate(
                    ...
                    actions=[
                        PostbackAction(
                            label='電機工程學系',
                            display_text='正在爬取電機工程學系(' + event.postback.data.split('電機資訊學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('電機資訊學院')[1] + ' ' + department_number['電機']
                        ),
                        PostbackAction(
                            label='資訊工程學系',
                            display_text='正在爬取資訊工程學系(' + event.postback.data.split('電機資訊學院')[1] + ')，請稍後...',
                            data=event.postback.data.split('電機資訊學院')[1] + ' ' + department_number['資工']
                        ),
                        PostbackAction(
                            label='通訊工程學系',
                            display_text='正在爬取通訊工程學系(' + event.postback.data.split('電機資訊學院')[1] + ')，請稍後...',
